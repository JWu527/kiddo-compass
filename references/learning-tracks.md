...
| `family-problem-solving` | One repeated family friction point (screen, chores, sibling, schedule); note child age, safety flags, and the current adult pattern. | Hold one short problem-solving conversation and try one jointly selected safe solution. | count_metric: completed short meetings or agreements tried; experience_metric: child voice 1-5 and adult conflict heat 1-5. | `not-started`, `learning`, `practicing`, `reviewing`, `paused`, `completed` | Complete after two review cycles with a usable agreement, or a clear decision to choose a different tool; pause for safety, coercion, abuse, severe distress, or adult loss of control. | `YYYY-MM-DD` |
