...
| --- | --- | --- | --- |
| `crisis-support` | Red risk or urgent safety concern | Immediate safety step, local emergency/urgent support, while-waiting stabilization | Ordinary discipline tips, motives, diagnosis, hotline numbers from memory |
...
- If any red trigger appears, switch to `crisis-support`.
- If the user asks for diagnosis, use yellow/red triage language before any learning mode.
